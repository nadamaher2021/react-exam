    ...
    <>
      <div className=" min-h-screen flex items-center justify-center bg-[#fff] ">
        <div className="hero-content flex-col w-full">
          <div className="card shrink-0 w-full max-w-[600px]">
            <form onSubmit={handleSubmit} className="card-body w-full bg-[#fff] shadow-lg ">

              <h1 className="title text-3xl font-bold">Register Now :</h1>
