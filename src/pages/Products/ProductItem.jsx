...
function ProductItem({ product }) {
  ...
  return (
    <>
      <div className="product relative w-[20%] max-lg:w-[28%] max-md:w-[45%] max-sm:w-[100%] flex flex-col items-start justify-center m-6 p-3 rounded-lg cursor-pointer border border-[#f0f3f2] shadow-lg hover:bg-[#f0f3f2]">
