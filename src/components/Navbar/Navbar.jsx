        ...
        <div>
          ...
          <div>
            <ul className="menu menu-horizontal max-md:hidden px-1 text-base">
              <li>
                <NavLink className={"sub-title text-xl font-bold"} to={"/products"}>
                  Products
                </NavLink>
              </li>
              <li>
                <NavLink className={"sub-title text-xl font-bold"} to={"/categories"}>
                  Categories
                </NavLink>
              </li>
              <li>
                <NavLink className={"sub-title text-xl font-bold"} to={"/brands"}>
                  Brands
                </NavLink>
              </li>
              <li>
                <NavLink className={"sub-title text-xl font-bold" } to={"/allorders"}>
                  Orders
                </NavLink>
              </li>
            </ul>
              ...
              >
                ...
                <li>
                  <NavLink
                    to={"/login"}
                    onClick={() => localStorage.clear()}
                    className={"sub-title text-xl font-bold"}
                  >
                    SignOut
                  </NavLink>
                </li>
